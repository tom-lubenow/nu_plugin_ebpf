...
- [~] Keep the user-facing surface small and Nushell-first.
  ...
  - Recent progress: ordinary zero-argument `random int` now lowers to `bpf_get_prandom_u32`, keeping pseudo-randomness on a Nushell primitive instead of adding a bespoke helper wrapper.
