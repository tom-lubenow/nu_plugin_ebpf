...
- [~] Add kernel-version and feature metadata.
  ...
  - Common helper floors used by current verifier fixtures and first-class surfaces now have source-backed `BpfHelper` metadata; continue wiring helper usage into compiled-object diagnostics and fixture derivation, and track remaining helpers, kfuncs, context fields, attach modes, and loader features once each value is source-verified.
