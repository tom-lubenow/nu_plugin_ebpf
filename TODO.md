...
- [~] Add kfunc and richer BTF-driven typing support.
  ...
  - Added stack-slot base-pointer identity checks for by-reference stack buffer args (`bpf_path_d_path arg1`, `scx_bpf_events arg0`, `bpf_copy_from_user*_str arg0`) across type inference, verifier_types, and VCC.
