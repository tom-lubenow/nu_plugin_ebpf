...
- [~] Support global/static data sections.
  ...
  - Recent progress: metadata-built record values can now seed mutable captured globals and first-write `global-set` layout inference directly, with on-demand stack materialization preserving nested string/list field semantics instead of forcing an intermediate local binding.
