...
- [~] Finish resource-backed map semantics.
  ...
  - Map key/value type-spec parser rejects now name the map schema context or offending record field rather than using global wording for invalid array lengths, capacities, unsupported specs, record/array candidate brace errors, graph-root payload brace errors, and nested dynptr/graph/kptr object specs.
