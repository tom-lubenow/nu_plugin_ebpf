...
- [~] Add kernel-version and feature metadata.
  ...
  - Kfunc compatibility can now express source-checked upper bounds for removed/renamed kfunc windows; keep no-hit sched_ext names unmodeled until they are found in primary kernel sources.
