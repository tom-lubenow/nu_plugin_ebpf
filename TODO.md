...
- [~] Add kernel-version and feature metadata.
  ...
  - Some sched_ext kfunc names exist only in older kernel windows; keep those unmodeled until kfunc compatibility can express removed/renamed ranges rather than minimum-only availability.
