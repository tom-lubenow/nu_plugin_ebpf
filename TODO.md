...
- [~] Add kernel-version and feature metadata.
  ...
  - Map-kind kernel floors are now source-backed in `MapKind`, aggregated from compiled object map lists, and checked before live load; continue wiring that metadata into verifier fixture derivation.
