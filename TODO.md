...
- [~] Finish resource-backed map semantics.
  ...
  - Map key/value type-spec parser rejects now name the map schema context rather than using global wording for invalid array lengths, capacities, unsupported specs, record/array candidate brace errors, and graph-root payload brace errors.
