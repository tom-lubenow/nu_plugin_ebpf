...
- [~] Support global/static data sections.
  ...
  - Recent progress: reassigned captured numeric scalars and representable constant records now lower as compiler-managed mutable globals backed by `.data`/`.bss`.
  - Remaining: broaden mutable globals beyond scalar/record capture cases and carry that through more types/layouts.
