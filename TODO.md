...
- [~] Support global/static data sections.
  ...
  - Recent progress: explicit `global-define --type ...` declarations now also expose fixed scalar arrays with `array{scalar:N}`, including nested record fields and compile-time list initializers that are zero-padded to the declared length.
