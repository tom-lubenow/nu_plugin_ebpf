...
- [~] Finish resource-backed map semantics.
  ...
  - Socket-local storage fixtures still need kernel promotion; align `ctx.sk` owner lowering with the verifier's per-program expectations for `bpf_sk_storage_get/delete`.
