...
const IPV4_FIELDS: &[PacketHeaderFieldSpec] = &[
    ...
    packet_bitfield("more_fragments", PacketHeaderFieldType::U16, 6, 13, 1, true),
    packet_bitfield("dont_fragment", PacketHeaderFieldType::U16, 6, 14, 1, true),
    packet_bitfield("reserved_flag", PacketHeaderFieldType::U16, 6, 15, 1, true),
