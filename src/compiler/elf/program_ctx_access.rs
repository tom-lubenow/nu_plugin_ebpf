...
pub(super) const ITER_TASK_PAYLOAD_TARGETS: &[IterTargetKind] = &[
    IterTargetKind::Task,
    IterTargetKind::TaskFile,
    IterTargetKind::TaskVma,
];
pub(super) const ITER_TASK_FILE_TARGETS: &[IterTargetKind] = &[IterTargetKind::TaskFile];
pub(super) const ITER_TASK_VMA_TARGETS: &[IterTargetKind] = &[IterTargetKind::TaskVma];
pub(super) const ITER_CGROUP_TARGETS: &[IterTargetKind] = &[IterTargetKind::Cgroup];
pub(super) const ITER_MAP_TARGETS: &[IterTargetKind] = &[
    IterTargetKind::BpfMap,
    IterTargetKind::BpfMapElem,
    IterTargetKind::BpfSkStorageMap,
    IterTargetKind::Sockmap,
];
pub(super) const ITER_MAP_KEY_TARGETS: &[IterTargetKind] =
    &[IterTargetKind::BpfMapElem, IterTargetKind::Sockmap];
pub(super) const ITER_MAP_VALUE_TARGETS: &[IterTargetKind] =
    &[IterTargetKind::BpfMapElem, IterTargetKind::BpfSkStorageMap];
pub(super) const ITER_PROG_TARGETS: &[IterTargetKind] = &[IterTargetKind::BpfProg];
pub(super) const ITER_LINK_TARGETS: &[IterTargetKind] = &[IterTargetKind::BpfLink];
const ITER_SOCK_TARGETS: &[IterTargetKind] =
    &[IterTargetKind::BpfSkStorageMap, IterTargetKind::Sockmap];
pub(super) const ITER_TCP_TARGETS: &[IterTargetKind] = &[IterTargetKind::Tcp];
pub(super) const ITER_UDP_TARGETS: &[IterTargetKind] = &[IterTargetKind::Udp];
pub(super) const ITER_UNIX_TARGETS: &[IterTargetKind] = &[IterTargetKind::Unix];
pub(super) const ITER_SOCKET_UID_TARGETS: &[IterTargetKind] = &[
    IterTargetKind::Tcp,
    IterTargetKind::Udp,
    IterTargetKind::Unix,
];
pub(super) const ITER_DMABUF_TARGETS: &[IterTargetKind] = &[IterTargetKind::Dmabuf];
pub(super) const ITER_IPV6_ROUTE_TARGETS: &[IterTargetKind] = &[IterTargetKind::Ipv6Route];
pub(super) const ITER_KMEM_CACHE_TARGETS: &[IterTargetKind] = &[IterTargetKind::KmemCache];
pub(super) const ITER_KSYM_TARGETS: &[IterTargetKind] = &[IterTargetKind::Ksym];
pub(super) const ITER_NETLINK_TARGETS: &[IterTargetKind] = &[IterTargetKind::Netlink];
...
const SOCKET_FILTER_CTX_FIELD_ACCESS_SURFACES: &[ContextFieldAccessSurfaceSpec] = &[
    ContextFieldAccessSurfaceSpec::new(
        ...
        ContextFieldAccessRequirement::AllowedProgramsLabel(
            "tc_action, tc, tcx, and netkit programs",
        ),
    ),
    ContextFieldAccessSurfaceSpec::new(
        CtxField::WireLen,
    ...
    ContextFieldAccessSurfaceSpec::new(
        ...
        "tstamp",
        ContextFieldAccessRequirement::AllowedProgramsLabel(
            "tc_action, tc, tcx, netkit, and cgroup_skb programs",
        ),
    ),
    ContextFieldAccessSurfaceSpec::new(
        CtxField::TstampType,
...
const SK_SKB_CTX_FIELD_ACCESS_SURFACES: &[ContextFieldAccessSurfaceSpec] = &[
    ...
    ContextFieldAccessSurfaceSpec::new(
        ...
        "mark",
        ContextFieldAccessRequirement::AllowedProgramsLabel(
            "cgroup_sock, socket_filter, lwt_*, tc_action, tc, tcx, netkit, and cgroup_skb programs",
        ),
    ),
];
...
const ITER_CTX_FIELD_ACCESS_SURFACES: &[ContextFieldAccessSurfaceSpec] = &[
    ...
    ContextFieldAccessSurfaceSpec::new(
        ...
        ContextFieldAccessRequirement::IterTargetsOnly(
            ITER_MAP_TARGETS,
            "iter:bpf_map, iter:bpf_map_elem, iter:bpf_sk_storage_map, and iter:sockmap",
        ),
    ),
    ContextFieldAccessSurfaceSpec::new(
        CtxField::IterMapKey,
        "iter_key",
        ContextFieldAccessRequirement::IterTargetsOnly(
            ITER_MAP_KEY_TARGETS,
            "iter:bpf_map_elem and iter:sockmap",
        ),
    ),
    ContextFieldAccessSurfaceSpec::new(
    ...
    ContextFieldAccessSurfaceSpec::new(
        CtxField::IterProg,
        "iter_prog",
        ContextFieldAccessRequirement::IterTargetsOnly(ITER_PROG_TARGETS, "iter:bpf_prog"),
    ),
    ContextFieldAccessSurfaceSpec::new(
        CtxField::IterLink,
        "iter_link",
...
fn packet_field_access_error(program_type: EbpfProgramType, field: &CtxField) -> String {
    if program_type.packet_context_kind().is_some() {
        ...
        format!(
            "ctx.{} is only available on packet-context programs (xdp, flow_dissector, socket_filter, lwt_*, tc_action, tc, tcx, netkit, cgroup_skb, sk_reuseport, sk_msg, sk_skb, sk_skb_parser, and packet-aware sock_ops callbacks)",
            field.display_name()
        )
    }
}
    ...
    fn error(self, program_type: EbpfProgramType, field: &CtxField) -> String {
        match self {
            ...
            Self::SkbChecksumHelperFields => format!(
                "ctx.{} is only available on lwt_xmit, tc_action, tc, tcx, netkit, sk_skb, and sk_skb_parser programs",
                field.display_name()
            ),
            Self::SkbHashHelperFields => format!(
                "ctx.{} is only available on lwt_*, tc_action, tc, tcx, netkit, sk_skb, and sk_skb_parser programs",
                field.display_name()
            ),
            Self::TcLwtHelperFields => format!(
                "ctx.{} is only available on tc_action, tc, tcx, netkit, and lwt_* programs",
                field.display_name()
            ),
            Self::SkbFields => {
                let label = match field {
                    ...
                    _ => "socket_filter, lwt_*, tc_action, tc, tcx, netkit, cgroup_skb, sk_skb, and sk_skb_parser programs",
                };
                format!(
            ...
            Self::DataMetaField => {
                format!(
                    "ctx.{} is only available on xdp, tc_action, tc, tcx, and netkit programs",
                    field.display_name()
                )
            }
            ...
            Self::SocketRefField => format!(
                "ctx.{} is only available on socket_filter, tc_action, tc, tcx, netkit, cgroup_skb, cgroup_sock, cgroup_sock_addr, cgroup_sockopt, sk_lookup, sk_reuseport, sk_msg, sk_skb, sk_skb_parser, and sock_ops programs",
                field.display_name()
            ),
            ...
            Self::SocketUidField => format!(
                "ctx.{} is only available on socket_filter, tc_action, tc, tcx, netkit, cgroup_skb, sk_skb, and sk_skb_parser programs",
                field.display_name()
            ),
            Self::NetnsCookieField => format!(
                "ctx.{} is only available on socket_filter, tc_action, tc, tcx, netkit, cgroup_skb, cgroup_sock, cgroup_sockopt, cgroup_sock_addr, sk_msg, and sock_ops programs",
                field.display_name()
            ),
            ...
            Self::SockMarkPriorityFields => format!(
                "ctx.{} is only available on cgroup_sock, socket_filter, lwt_*, tc_action, tc, tcx, netkit, cgroup_skb, sk_skb, and sk_skb_parser programs",
                field.display_name()
            ),
            ...
            Self::ArgCountField => {
                "ctx.arg_count is only available on BTF-backed tracing contexts with argument metadata support (fentry, fexit, fmod_ret, tp_btf, lsm, and lsm_cgroup)".to_string()
            }
...
mod tests {
    ...
    fn test_iter_payload_fields_have_explicit_access_surfaces() {
        ...
        let bpf_map = ProgramSpec::parse("iter:bpf_map").expect("iter bpf_map spec should parse");
        assert!(bpf_map.ctx_field_access_error(&CtxField::IterMap).is_none());
        assert!(
            bpf_map
        ...
        let bpf_map_elem =
            ProgramSpec::parse("iter:bpf_map_elem").expect("iter bpf_map_elem spec should parse");
        assert!(
            bpf_map_elem
        ...
        let bpf_prog =
            ProgramSpec::parse("iter:bpf_prog").expect("iter bpf_prog spec should parse");
        assert!(
            bpf_prog
                .ctx_field_access_error(&CtxField::IterProg)
                .is_none()
        );
        assert!(
            bpf_prog
        ...
        let bpf_link =
            ProgramSpec::parse("iter:bpf_link").expect("iter bpf_link spec should parse");
        assert!(
            bpf_link
                .ctx_field_access_error(&CtxField::IterLink)
                .is_none()
        );
        assert!(
            bpf_link
