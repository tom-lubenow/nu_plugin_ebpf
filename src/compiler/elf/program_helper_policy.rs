...
const HELPER_PROGRAM_SURFACE_FAMILY_SPECS: &[HelperProgramSurfaceFamilySpec] = &[
    ...
    HelperProgramSurfaceFamilySpec {
        family: HelperProgramSurfaceFamily::CoarseTimestamp,
        program_types: &[
            EbpfProgramType::Xdp,
            EbpfProgramType::SocketFilter,
            EbpfProgramType::CgroupDevice,
        ...
        label: "xdp, socket_filter, cgroup_device, sk_lookup, flow_dissector, netfilter, lwt_*, sk_reuseport, sk_msg, sk_skb, sk_skb_parser, sock_ops, tc_action, tc, tcx, netkit, cgroup_skb, cgroup_sock, cgroup_sysctl, cgroup_sockopt, cgroup_sock_addr, and lirc_mode2",
    },
    HelperProgramSurfaceFamilySpec {
...
fn helper_program_surface_spec(helper: BpfHelper) -> Option<HelperProgramSurfaceSpec> {
    Some(match helper {
        ...
        BpfHelper::KtimeGetCoarseNs => HelperProgramSurfaceSpec {
            family: HelperProgramSurfaceFamily::CoarseTimestamp,
        },
