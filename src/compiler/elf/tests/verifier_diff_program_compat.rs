...
// Enumerates every syscall whose fallback payload fields are modeled in
// TracepointContext::well_known_sys_enter_arg_fields.
const MODELED_SYSCALL_TRACEPOINT_PAYLOAD_SCANNER_SYSCALLS: &[&str] = &[
    "read",
    "write",
    "close",
    "open",
...
fn all_modeled_tracepoint_payload_scanner_checks() -> Vec<(String, String)> {
    ...
    for syscall in MODELED_SYSCALL_TRACEPOINT_PAYLOAD_SCANNER_SYSCALLS {
