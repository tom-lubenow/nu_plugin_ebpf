...
fn test_verifier_diff_tracepoint_payload_scanner_matches_rust_fallback_fields() {
    let checks = [
        ...
        ("tracepoint:syscalls/sys_enter_open", "filename"),
        ("tracepoint:syscalls/sys_enter_open", "flags"),
        ("tracepoint:syscalls/sys_enter_fchownat", "flag"),
        ...
        ("tracepoint:syscalls/sys_enter_mknod", "dev"),
        ("tracepoint:syscalls/sys_enter_rmdir", "pathname"),
