...
use crate::compiler::test_mir_builders::{
    ...
    packet_dynptr_kfunc_join_reinitialize_mir,
...
#[test]
fn test_verify_mir_kfunc_crypto_ctx_release_accepts_explicit_null_after_acquire_join() {
...
#[test]
fn test_verify_mir_kfunc_crypto_ctx_release_accepts_explicit_null_phi_after_acquire_join() {
    assert_explicit_null_ref_join_release_accepts(ExplicitNullRefKfuncCase::CryptoCtxAcquire, true);
}

#[test]
fn test_verify_mir_kfunc_obj_drop_accepts_explicit_null_after_new_join() {
    assert_explicit_null_ref_join_release_accepts(ExplicitNullRefKfuncCase::ObjNewImpl, false);
}

#[test]
fn test_verify_mir_kfunc_obj_drop_accepts_explicit_null_phi_after_new_join() {
...
#[test]
fn test_verify_mir_kfunc_res_spin_lock_requires_res_spin_lock_pointee() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_list_front_accepts_same_key_repeated_map_lookup_bpf_spin_lock() {
...
#[test]
fn test_verify_mir_kfunc_list_front_accepts_copied_dynamic_key_repeated_map_lookup_bpf_spin_lock() {
...
#[test]
fn test_verify_mir_kfunc_list_front_rejects_offset_dynamic_key_repeated_map_lookup_bpf_spin_lock() {
...
#[test]
fn test_verify_mir_kfunc_list_front_accepts_equivalent_expr_key_repeated_map_lookup_bpf_spin_lock()
{
...
#[test]
fn test_verify_mir_kfunc_list_front_rejects_different_expr_key_repeated_map_lookup_bpf_spin_lock() {
...
#[test]
fn test_verify_mir_kfunc_list_front_accepts_same_ctx_field_repeated_map_lookup_bpf_spin_lock() {
...
#[test]
fn test_verify_mir_kfunc_list_front_rejects_different_key_repeated_map_lookup_bpf_spin_lock() {
...
#[test]
fn test_verify_mir_kfunc_copy_from_user_str_rejects_zero_size() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_copy_from_user_task_str_rejects_zero_size() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_copy_from_user_dynptr_src_requires_user_pointer() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_copy_from_user_dynptr_rejects_zero_size() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_copy_from_user_dynptr_requires_stack_slot_base_dptr() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_packet_dynptr_kfuncs_initialize_stack_slot() {
    for kfunc in ["bpf_dynptr_from_xdp", "bpf_dynptr_from_skb"] {
        let (func, types) = make_packet_dynptr_kfunc_vcc_function(kfunc, 0, false, true);
...
#[test]
fn test_verify_mir_kfunc_dynptr_subfn_clone_initializes_destination_stack_slot() {
...
#[test]
fn test_verify_mir_unknown_stack_object_subfn_conditional_init_blocks_reinitialize() {
...
#[test]
fn test_verify_mir_unknown_stack_object_subfn_lifecycle_composes() {
...
#[test]
fn test_verify_mir_unknown_stack_object_subfn_copy_initializes_destination_stack_slot() {
...
#[test]
fn test_verify_mir_unknown_stack_object_subfn_init_blocks_reinitialize() {
...
#[test]
fn test_verify_mir_dynptr_from_xdp_rejects_non_xdp_program() {
    let (func, types) =
        make_packet_dynptr_kfunc_vcc_function("bpf_dynptr_from_xdp", 0, false, false);
...
fn make_packet_dynptr_kfunc_vcc_function_with_arg0(
    ...
    make_packet_dynptr_kfunc_vcc_function_with_arg0_copy(kfunc, arg0_field, arg0_type, false)
}

fn make_packet_dynptr_kfunc_vcc_function_with_copied_arg0(
    kfunc: &str,
    arg0_field: CtxField,
    arg0_type: MirType,
) -> (MirFunction, HashMap<VReg, MirType>) {
    make_packet_dynptr_kfunc_vcc_function_with_arg0_copy(kfunc, arg0_field, arg0_type, true)
}

fn make_packet_dynptr_kfunc_vcc_function_with_arg0_copy(
    kfunc: &str,
    arg0_field: CtxField,
    arg0_type: MirType,
    copy_arg0: bool,
...
#[test]
fn test_verify_mir_dynptr_from_xdp_accepts_copied_raw_context_arg0() {
    let (func, types) = make_packet_dynptr_kfunc_vcc_function_with_copied_arg0(
        "bpf_dynptr_from_xdp",
        CtxField::Context,
        MirType::Ptr {
            pointee: Box::new(MirType::U8),
...
#[test]
fn test_verify_mir_dynptr_from_xdp_rejects_copied_packet_pointer_arg0() {
    let (func, types) = make_packet_dynptr_kfunc_vcc_function_with_copied_arg0(
        "bpf_dynptr_from_xdp",
        CtxField::Data,
        MirType::Ptr {
...
#[test]
fn test_verify_mir_dynptr_from_skb_accepts_copied_tc_raw_context_arg0() {
    let (func, types) = make_packet_dynptr_kfunc_vcc_function_with_copied_arg0(
        "bpf_dynptr_from_skb",
        CtxField::Context,
        MirType::Ptr {
...
#[test]
fn test_verify_mir_dynptr_from_skb_rejects_copied_packet_pointer_arg0() {
    let (func, types) = make_packet_dynptr_kfunc_vcc_function_with_copied_arg0(
        "bpf_dynptr_from_skb",
        CtxField::Data,
        MirType::Ptr {
...
#[test]
fn test_verify_mir_dynptr_from_skb_rejects_indirect_skb_raw_context() {
    let (func, types) =
        make_packet_dynptr_kfunc_vcc_function("bpf_dynptr_from_skb", 0, false, false);
...
#[test]
fn test_verify_mir_dynptr_from_skb_rejects_non_skb_program() {
    let (func, types) =
        make_packet_dynptr_kfunc_vcc_function("bpf_dynptr_from_skb", 0, false, false);
...
#[test]
fn test_verify_mir_packet_dynptr_kfuncs_reject_reinitialize() {
    for kfunc in ["bpf_dynptr_from_xdp", "bpf_dynptr_from_skb"] {
        let (func, types) = make_packet_dynptr_kfunc_vcc_function(kfunc, 0, true, false);
        let err =
...
#[test]
fn test_verify_mir_packet_dynptr_kfuncs_reject_destination_initialized_on_one_path() {
    for kfunc in ["bpf_dynptr_from_xdp", "bpf_dynptr_from_skb"] {
...
#[test]
fn test_verify_mir_kfunc_dynptr_clone_requires_stack_slot_base_dst() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_dynptr_clone_rejects_same_stack_slot_src_and_dst() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_dynptr_clone_initializes_destination_stack_slot() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_scx_error_bstr_requires_stack_slot_base_fmt() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_scx_exit_bstr_requires_stack_slot_base_data() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_iter_num_new_rejects_reinit_after_mixed_join() {
    let (mut func, entry) = new_mir_function();
    let new_path = func.alloc_block();
    let no_new_path = func.alloc_block();
    let join = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_crypto_ctx_acquire_release_semantics() {
    let (mut func, entry) = new_mir_function();
    let release = func.alloc_block();
    let done = func.alloc_block();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_crypto_ctx_release_rejects_task_reference() {
    let (mut func, entry) = new_mir_function();
    let release = func.alloc_block();
    let done = func.alloc_block();
    ...
    assert!(
        err.iter()
            .any(|e| e.message.contains("expects crypto_ctx reference")),
        "unexpected error messages: {:?}",
        err
    );
    assert!(
...
#[test]
fn test_verify_mir_kfunc_crypto_encrypt_accepts_tracked_crypto_ctx_reference() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_crypto_encrypt_rejects_task_reference_argument() {
    let (mut func, entry) = new_mir_function();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_crypto_encrypt_src_requires_stack_or_map_space() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_crypto_decrypt_src_requires_stack_or_map_space() {
    let (mut func, entry) = new_mir_function();
    let src_ok = func.alloc_block();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_crypto_encrypt_dst_requires_stack_slot_base_pointer() {
    let (mut func, entry) = new_mir_function();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_crypto_ctx_create_params_requires_stack_or_map_space() {
    let (mut func, entry) = new_mir_function();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_crypto_ctx_create_rejects_zero_params_size() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_crypto_ctx_create_err_requires_stack_slot_base_pointer() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_list_push_rejects_nonzero_meta() {
...
#[test]
fn test_verify_mir_kfunc_list_push_rejects_dynamic_meta() {
    for kfunc in ["bpf_list_push_front_impl", "bpf_list_push_back_impl"] {
        let (mut func, entry) = new_mir_function();
        let push = func.alloc_block();
        let done = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_rbtree_add_rejects_nonzero_meta() {
    let (mut func, entry) = new_mir_function();
    let add = func.alloc_block();
    let done = func.alloc_block();
    func.param_count = 2;
...
#[test]
fn test_verify_mir_kfunc_rbtree_add_rejects_dynamic_meta() {
    let (mut func, entry) = new_mir_function();
    let add = func.alloc_block();
    let done = func.alloc_block();
    func.param_count = 2;
...
#[test]
fn test_verify_mir_kfunc_object_new_rejects_dynamic_meta() {
    for kfunc in ["bpf_obj_new_impl", "bpf_percpu_obj_new_impl"] {
        let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_object_drop_rejects_dynamic_meta() {
    for (new_kfunc, drop_kfunc) in [
        ("bpf_obj_new_impl", "bpf_obj_drop_impl"),
        ("bpf_percpu_obj_new_impl", "bpf_percpu_obj_drop_impl"),
    ] {
...
#[test]
fn test_verify_mir_kfunc_refcount_acquire_rejects_object_without_refcount_payload() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_task_release_accepts_explicit_null_after_acquire_join() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_task_release_accepts_explicit_null_phi_after_acquire_join() {
    let (mut func, entry) = new_mir_function();
    let acquire_path = func.alloc_block();
    let null_path = func.alloc_block();
    let join = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_task_release_rejected_after_partial_acquire_join() {
    let (mut func, entry) = new_mir_function();
    let acquire_path = func.alloc_block();
    let join = func.alloc_block();
    let release = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_rcu_subfn_lock_unlock_balanced() {
    let (mut acquire, acquire_entry) = new_mir_function();
    ...
    let (mut release, release_entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_init_rejects_dynamic_flags() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_init_subfn_accepts_matching_map_fd() {
    let (mut func, entry) = new_mir_function();
    let wq_loaded = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_init_subfn_rejects_mismatched_map_fd() {
    let (mut func, entry) = new_mir_function();
    let wq_loaded = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_set_callback_accepts_callback_and_zero_aux() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_set_callback_rejects_nonzero_flags() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
    ...
    let err = verify_mir(&func, &types)
        .expect_err("expected bpf_wq_set_callback_impl nonzero flags error");
    assert!(
        err.iter().any(|e| {
            e.message
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_set_callback_rejects_dynamic_flags() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
    ...
    let err = verify_mir(&func, &types)
        .expect_err("expected bpf_wq_set_callback_impl dynamic flags error");
    assert!(
        err.iter().any(|e| {
            e.message
                .contains("kfunc 'bpf_wq_set_callback_impl' arg2 must be known zero")
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_set_callback_rejects_nonzero_aux() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
    ...
    let err =
        verify_mir(&func, &types).expect_err("expected bpf_wq_set_callback_impl nonzero aux error");
    assert!(
        err.iter().any(|e| {
            e.message
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_set_callback_rejects_dynamic_aux() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
    ...
    let err =
        verify_mir(&func, &types).expect_err("expected bpf_wq_set_callback_impl dynamic aux error");
    assert!(
        err.iter().any(|e| {
            e.message
                .contains("kfunc 'bpf_wq_set_callback_impl' arg3 must be known zero")
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_set_callback_rejects_stack_wq() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_set_callback_requires_null_checked_map_lookup() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_start_rejects_dynamic_flags() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_bpf_wq_start_requires_null_checked_map_lookup() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_list_front_accepts_offset_zero_enclosing_root_pointer() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 2;
...
#[test]
fn test_verify_mir_kfunc_local_irq_subfn_save_restore_balanced() {
    let (mut save, save_entry) = new_mir_function();
    save.param_count = 1;
    save.vreg_count = 1;
    ...
    let (mut restore, restore_entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_res_spin_lock_rejects_same_lock_twice() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_res_spin_lock_rejects_calls_while_held() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_res_spin_unlock_rejects_out_of_order_lock() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 2;
...
#[test]
fn test_verify_mir_kfunc_res_spin_lock_irqsave_rejects_helper_while_held() {
    let (mut func, entry) = new_mir_function();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_crypto_encrypt_siv_allows_known_zero_vreg() {
    let (mut func, entry) = new_mir_function();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_crypto_encrypt_siv_rejects_non_zero_vreg() {
    let (mut func, entry) = new_mir_function();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_crypto_decrypt_siv_allows_const_zero_scalar() {
    let (mut func, entry) = new_mir_function();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
    func.param_count = 1;
...
#[test]
fn test_verify_mir_kfunc_crypto_decrypt_siv_rejects_non_zero_scalar() {
    let (mut func, entry) = new_mir_function();
    let use_ctx = func.alloc_block();
    let done = func.alloc_block();
    func.param_count = 1;
    ...
    let err = verify_mir(&func, &types)
        .expect_err("expected non-zero scalar crypto_decrypt siv verifier error");
    assert!(
        err.iter().any(|e| e
            .message
            .contains("kfunc 'bpf_crypto_decrypt' arg3 expects null (0) or pointer value")),
        "unexpected error messages: {:?}",
        err
    );
}
...
#[test]
fn test_verify_mir_kfunc_dynptr_slice_buffer_allows_const_zero_scalar() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_dynptr_slice_buffer_rejects_non_zero_scalar() {
    let (mut func, entry) = new_mir_function();
    ...
    let err = verify_mir(&func, &types)
        .expect_err("expected non-zero scalar dynptr_slice buffer verifier error");
    assert!(
        err.iter().any(|e| e
            .message
...
#[test]
fn test_verify_mir_kfunc_dynptr_slice_buffer_allows_known_zero_vreg() {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_kfunc_dynptr_slice_buffer_rejects_non_zero_vreg() {
    let (mut func, entry) = new_mir_function();
...
fn make_xdp_metadata_kfunc_vcc_function(
    kfunc: &str,
...
fn assert_xdp_metadata_kfunc_accepts_stack_outputs(kfunc: &str, outputs: &[(usize, MirType)]) {
    let (func, types) = make_xdp_metadata_kfunc_vcc_function(kfunc, outputs, None);
    let probe_ctx = ProbeContext::new(EbpfProgramType::Xdp, "lo");
    verify_mir_for_probe_context(&func, &types, &probe_ctx)
...
fn assert_xdp_metadata_kfunc_rejects_packet_output(kfunc: &str, outputs: &[(usize, MirType)]) {
    for packet_idx in 0..outputs.len() {
        let (func, types) = make_xdp_metadata_kfunc_vcc_function(kfunc, outputs, Some(packet_idx));
        let probe_ctx = ProbeContext::new(EbpfProgramType::Xdp, "lo");
        ...
        assert!(
            ...
            "unexpected error messages for {kfunc} output {packet_idx}: {:?}",
            err
        );
    }
}
...
#[test]
fn test_verify_mir_xdp_metadata_rx_hash_accepts_stack_output_buffers() {
    assert_xdp_metadata_kfunc_accepts_stack_outputs(
...
#[test]
fn test_verify_mir_xdp_metadata_rx_hash_rejects_packet_output_buffers() {
    assert_xdp_metadata_kfunc_rejects_packet_output(
        "bpf_xdp_metadata_rx_hash",
        &[(4, MirType::U32), (4, MirType::U32)],
    );
...
#[test]
fn test_verify_mir_xdp_metadata_rx_vlan_tag_accepts_stack_output_buffers() {
    assert_xdp_metadata_kfunc_accepts_stack_outputs(
...
#[test]
fn test_verify_mir_xdp_metadata_rx_vlan_tag_rejects_packet_output_buffers() {
    assert_xdp_metadata_kfunc_rejects_packet_output(
        "bpf_xdp_metadata_rx_vlan_tag",
        &[(2, MirType::U16), (2, MirType::U16)],
    );
...
fn make_sock_addr_set_sun_path_vcc_function_with_copied_arg0(
    arg0_field: CtxField,
) -> (MirFunction, HashMap<VReg, MirType>) {
    make_sock_addr_set_sun_path_vcc_function_with_size(arg0_field, 17)
}

fn make_sock_addr_set_sun_path_vcc_function_with_size(
    arg0_field: CtxField,
    size_value: i64,
) -> (MirFunction, HashMap<VReg, MirType>) {
    let (mut func, entry) = new_mir_function();
...
#[test]
fn test_verify_mir_sock_addr_set_sun_path_rejects_zero_size() {
    let (func, types) = make_sock_addr_set_sun_path_vcc_function_with_size(CtxField::Context, 0);
...
#[test]
fn test_verify_mir_sock_addr_set_sun_path_accepts_copied_raw_context_arg0() {
    let (func, types) =
        make_sock_addr_set_sun_path_vcc_function_with_copied_arg0(CtxField::Context);
    let probe_ctx = ProbeContext::new(
        EbpfProgramType::CgroupSockAddr,
        "/sys/fs/cgroup:connect_unix",
    );
...
#[test]
fn test_verify_mir_sock_addr_set_sun_path_rejects_copied_socket_arg0() {
    let (func, types) = make_sock_addr_set_sun_path_vcc_function_with_copied_arg0(CtxField::Socket);
    let probe_ctx = ProbeContext::new(
        EbpfProgramType::CgroupSockAddr,
        "/sys/fs/cgroup:connect_unix",
    );
...
fn make_xdp_get_xfrm_state_vcc_function(
    ...
    make_xdp_get_xfrm_state_vcc_function_with_arg0(
        CtxField::Context,
        MirType::Ptr {
            pointee: Box::new(MirType::U8),
            address_space: AddressSpace::Kernel,
...
fn make_xdp_get_xfrm_state_vcc_function_with_arg0(
    arg0_field: CtxField,
    arg0_type: MirType,
    opts_size: i64,
    buffer_size: usize,
    ...
    make_xdp_get_xfrm_state_vcc_function_with_arg0_copy(
        arg0_field,
        arg0_type,
        opts_size,
        buffer_size,
...
fn make_xdp_get_xfrm_state_vcc_function_with_copied_arg0(
    arg0_field: CtxField,
    arg0_type: MirType,
    opts_size: i64,
    buffer_size: usize,
...
fn make_xdp_get_xfrm_state_vcc_function_with_arg0_copy(
    arg0_field: CtxField,
    arg0_type: MirType,
    opts_size: i64,
    buffer_size: usize,
...
#[test]
fn test_verify_mir_xdp_get_xfrm_state_release_accepts_xdp() {
    let (func, types) = make_xdp_get_xfrm_state_vcc_function(32, 32, true);
    let probe_ctx = ProbeContext::new(EbpfProgramType::Xdp, "lo");
...
#[test]
fn test_verify_mir_xdp_get_xfrm_state_rejects_non_xdp_program() {
    let (func, types) = make_xdp_get_xfrm_state_vcc_function(32, 32, true);
    let probe_ctx = ProbeContext::new(EbpfProgramType::Tc, "lo:ingress");
...
#[test]
fn test_verify_mir_xdp_get_xfrm_state_requires_release() {
    let (func, types) = make_xdp_get_xfrm_state_vcc_function(32, 32, false);
    let probe_ctx = ProbeContext::new(EbpfProgramType::Xdp, "lo");
...
#[test]
fn test_verify_mir_xdp_get_xfrm_state_rejects_small_opts_buffer() {
    let (func, types) = make_xdp_get_xfrm_state_vcc_function(32, 16, true);
    let probe_ctx = ProbeContext::new(EbpfProgramType::Xdp, "lo");
...
#[test]
fn test_verify_mir_xdp_get_xfrm_state_accepts_copied_raw_context_arg0() {
    let (func, types) = make_xdp_get_xfrm_state_vcc_function_with_copied_arg0(
        CtxField::Context,
        MirType::Ptr {
            pointee: Box::new(MirType::U8),
            address_space: AddressSpace::Kernel,
...
#[test]
fn test_verify_mir_xdp_get_xfrm_state_rejects_copied_packet_arg0() {
    let (func, types) = make_xdp_get_xfrm_state_vcc_function_with_copied_arg0(
        CtxField::Data,
        MirType::Ptr {
            pointee: Box::new(MirType::U8),
