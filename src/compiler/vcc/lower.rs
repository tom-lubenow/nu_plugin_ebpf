struct VccLowerer<'a> {
    ...
    scalar_alias_regs: HashMap<VccReg, VccReg>,
    map_lookup_regs: HashMap<VccReg, (MapRef, VccReg)>,
    map_fd_regs: HashMap<VccReg, MapRef>,
...
impl<'a> VccLowerer<'a> {
    ...
    fn new(
        ...
        Self {
            ...
            list_max,
            ptr_regs,
            scalar_alias_regs: HashMap::new(),
            map_lookup_regs: HashMap::new(),
            map_fd_regs: HashMap::new(),
