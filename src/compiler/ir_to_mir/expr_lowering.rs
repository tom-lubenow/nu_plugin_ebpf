...
#[derive(Debug, Clone)]
pub(super) struct TypedProjectionStep {
    pub(super) offset: usize,
    pub(super) ty: MirType,
    pub(super) bitfield: Option<TrampolineBitfieldInfo>,
    pub(super) packet_big_endian: bool,
}
...
impl<'a> HirToMirLowering<'a> {
    ...
    pub(super) fn trampoline_field_selector(
        member: &PathMember,
    ...
    pub(super) fn trampoline_field_path_desc(path: &[TrampolineFieldSelector]) -> String {
    ...
    pub(super) fn trampoline_value_spec(
        &self,
        field: &CtxField,
    ...
    pub(super) fn projected_trampoline_field_type(type_info: &TypeInfo) -> Option<MirType> {
        match type_info {
    ...
    pub(super) fn trampoline_root_type_info(
        &self,
        field: &CtxField,
    ...
    pub(super) fn root_trampoline_value_types(
        type_info: &TypeInfo,
    ...
    pub(super) fn trampoline_pointer_type(address_space: AddressSpace) -> MirType {
        MirType::Ptr {
    ...
    pub(super) fn emit_trampoline_probe_read_to_slot(
        &mut self,
        ptr_vreg: VReg,
    ...
    pub(super) fn lower_trampoline_field_projection(
        &mut self,
        dst_vreg: VReg,
        ctx_field: &CtxField,
    ...
    pub(super) fn resolve_typed_value_projection_path(
        current_ty: &MirType,
        members: &[PathMember],
        path_desc: &str,
    ) -> Result<TypedProjectionStep, CompileError> {
