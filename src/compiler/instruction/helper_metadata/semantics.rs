...
impl BpfHelper {
    pub const fn semantics(self) -> HelperSemantics {
        ...
        const PACKET_OUTPUT_RULES: &[HelperPtrArgRule] = &[
            ...
            HelperPtrArgRule {
                arg_idx: 3,
                op: "helper packet_output data",
                allowed: STACK_MAP,
                fixed_size: None,
                size_from_arg: Some(4),
            },
        ];
        const PERF_PROG_READ_VALUE_RULES: &[HelperPtrArgRule] = &[
            HelperPtrArgRule {
                arg_idx: 0,
                op: "helper perf_prog_read_value ctx",
                allowed: KERNEL,
                fixed_size: None,
                size_from_arg: None,
            },
            HelperPtrArgRule {
                arg_idx: 1,
                op: "helper perf_prog_read_value buf",
                allowed: STACK_MAP,
                fixed_size: None,
                size_from_arg: Some(2),
            },
