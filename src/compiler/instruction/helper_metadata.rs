...
impl BpfHelper {
    ...
    pub const fn from_u32(helper_id: u32) -> Option<Self> {
        match helper_id {
            ...
            186 => Some(Self::GetRetval),
            187 => Some(Self::SetRetval),
            ...
            169 => Some(Self::TimerInit),
            170 => Some(Self::TimerSetCallback),
            171 => Some(Self::TimerStart),
            172 => Some(Self::TimerCancel),
            175 => Some(Self::TaskPtRegs),
            179 => Some(Self::KallsymsLookupName),
            180 => Some(Self::FindVma),
            181 => Some(Self::BpfLoop),
            ...
            209 => Some(Self::UserRingbufDrain),
    ...
    pub const fn signature(self) -> HelperSignature {
        ...
        match self {
            ...
            BpfHelper::SendSignal | BpfHelper::SendSignalThread => HelperSignature {
                min_args: 1,
                max_args: 1,
                arg_kinds: [S, S, S, S, S],
                ret_kind: HelperRetKind::Scalar,
            ...
            BpfHelper::GetRetval => HelperSignature {
                min_args: 0,
                max_args: 0,
                arg_kinds: [S, S, S, S, S],
                ret_kind: HelperRetKind::Scalar,
            },
            BpfHelper::SetRetval => HelperSignature {
                min_args: 1,
                max_args: 1,
                arg_kinds: [S, S, S, S, S],
                ret_kind: HelperRetKind::Scalar,
            ...
            BpfHelper::TimerInit => HelperSignature {
                min_args: 3,
                max_args: 3,
                arg_kinds: [P, P, S, S, S],
                ret_kind: HelperRetKind::Scalar,
            ...
            BpfHelper::TimerCancel => HelperSignature {
                min_args: 1,
                max_args: 1,
                arg_kinds: [P, S, S, S, S],
                ret_kind: HelperRetKind::Scalar,
            ...
            BpfHelper::DynptrFromMem => HelperSignature {
                min_args: 4,
                max_args: 4,
                arg_kinds: [P, S, S, P, S],
                ret_kind: HelperRetKind::Scalar,
            ...
            BpfHelper::DynptrWrite => HelperSignature {
                min_args: 5,
                max_args: 5,
                arg_kinds: [P, S, P, S, S],
                ret_kind: HelperRetKind::Scalar,
            },
            BpfHelper::DynptrData => HelperSignature {
                min_args: 3,
                max_args: 3,
                arg_kinds: [P, S, S, S, S],
                ret_kind: HelperRetKind::PointerMaybeNull,
