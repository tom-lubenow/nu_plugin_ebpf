...
pub use elf::{
    ...
    EbpfMap, EbpfObject, EbpfProgram, EbpfProgramSection, EbpfProgramType, EventSchema,
    KernelTargetValidationKind, MapRelocation, ProbeContext, ProgramAttachKind, ProgramCapability,
