...
#[test]
fn test_helper_kptr_xchg_allows_zero_vreg_arg1() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_kptr_xchg_rejects_non_zero_vreg_arg1() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_kptr_xchg_rejects_flow_keys_context_arg1() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_kptr_xchg_release_rejected_after_partial_swap_join() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let swap = func.alloc_block();
    ...
    assert!(
        err.iter().any(|e| {
            e.message
                .contains("kfunc 'bpf_cgroup_release' arg0 expects acquired cgroup reference")
...
#[test]
fn test_helper_sk_release_rejected_after_partial_lookup_join() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let lookup = func.alloc_block();
    let join = func.alloc_block();
    ...
    assert!(
        err.iter().any(|e| {
            e.message
                .contains("helper 86 arg0 expects acquired socket reference")
                || e.message.contains("uninitialized")
        }),
        "unexpected errors: {:?}",
        err
...
#[test]
fn test_helper_sk_release_accepts_explicit_null_after_lookup_join() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let lookup = func.alloc_block();
...
#[test]
fn test_helper_sk_release_accepts_explicit_null_phi_after_lookup_join() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let lookup = func.alloc_block();
    let null_path = func.alloc_block();
...
#[test]
fn test_helper_sk_release_rejects_nonzero_scalar_phi_after_lookup_join() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let lookup = func.alloc_block();
...
#[test]
fn test_helper_sk_release_rejects_double_release() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let lookup = func.alloc_block();
    let release = func.alloc_block();
    ...
    let err = verify_mir(&func, &types).expect_err("expected sk_release double-release rejection");
    assert!(
        err.iter().any(|e| e
            .message
            .contains("helper 86 arg0 reference already released")),
        "unexpected errors: {:?}",
        err
    );
}
...
#[test]
fn test_helper_tcp_send_ack_rejects_non_socket_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_tcp_gen_syncookie_rejects_non_socket_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_sk_storage_get_rejects_non_socket_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_sk_storage_delete_rejects_non_socket_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_sk_assign_rejects_non_socket_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_sock_from_file_rejects_non_file_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_task_pt_regs_rejects_non_task_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_inode_storage_get_rejects_non_inode_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
#[test]
fn test_helper_inode_storage_delete_rejects_non_inode_reference() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    let call = func.alloc_block();
    let done = func.alloc_block();
...
fn test_helper_additional_skc_casts_reject_non_kernel_pointer() {
    let helpers = [
        ...
        (
            ...
            "helper skc_to_mptcp_sock sk expects pointer in [Kernel], got stack slot",
        ),
        (
...
#[test]
fn test_helper_sock_from_file_rejects_non_kernel_pointer() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    func.entry = entry;
    ...
    assert!(
        err.iter().any(|e| e
            .message
            .contains("helper sock_from_file file expects pointer in [Kernel], got stack slot")),
        "unexpected errors: {:?}",
        err
    );
}
...
#[test]
fn test_helper_task_pt_regs_rejects_non_kernel_pointer() {
    let mut func = MirFunction::new();
    let entry = func.alloc_block();
    func.entry = entry;
    ...
    assert!(
        err.iter().any(|e| e
            .message
            .contains("helper task_pt_regs task expects pointer in [Kernel], got stack slot")),
        "unexpected errors: {:?}",
        err
    );
}
