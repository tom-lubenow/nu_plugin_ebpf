...
impl VerifierState {
    ...
    pub(in crate::compiler::verifier_types) fn mark_unknown_stack_object_slot_maybe_initialized(
        &mut self,
        slot: StackSlotId,
        type_name: &str,
        type_id: Option<u32>,
    ...
    pub(in crate::compiler::verifier_types) fn first_live_unknown_stack_object_except_slots(
        &self,
        allowed_slots: &HashMap<StackSlotId, u32>,
    ) -> Option<(StackSlotId, String)> {
