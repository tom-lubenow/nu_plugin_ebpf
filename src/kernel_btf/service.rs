...
use raw_btf::{
    infer_kfunc_ret_shape, parse_declared_type_sizes_from_raw_btf,
    parse_function_proto_return_type_ids_from_raw_btf, parse_function_return_type_ids_from_raw_btf,
};
...
impl KernelBtf {
    ...
    fn has_user_type_tag(type_tags: &[String]) -> bool {
        type_tags
            .iter()
