...
- Ordinary Nushell primitives should stay ordinary when possible. For example, `random int` and the supported stack-list/fixed-record aggregate commands compile directly rather than through bespoke helper wrappers.
