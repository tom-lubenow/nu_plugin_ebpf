...
- Use `--pin` when multiple Aya-backed probes need to share maps or timers. libbpf-backed attach paths currently reject `--pin` until libbpf map reuse is integrated with the loader pin lifecycle.
