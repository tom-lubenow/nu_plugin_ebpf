...
- Fixed-layout `record{...}` specs use natural field alignment and an aligned array stride. Padding bytes are zero-filled by typed initializers and omitted from emitted BTF members.
