...
nu ./scripts/verifier_diff.nu --list --gap-only
nu ./scripts/verifier_diff.nu --matrix
nu ./scripts/verifier_diff.nu --matrix --gap-only
nu ./scripts/verifier_diff.nu --matrix --compat-kernel=5.10
nu ./scripts/verifier_diff.nu --matrix --json
nu ./scripts/verifier_diff.nu --chunks
nu ./scripts/verifier_diff.nu --chunks --gap-only
nu ./scripts/verifier_diff.nu --chunks --gap-only --test-lane dry-run
nu ./scripts/verifier_diff.nu --chunks --category maps
nu ./scripts/verifier_diff.nu --chunks --json
