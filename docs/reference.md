...
| `map-define` | Declare a named generic map value schema with `--value-type`, including fixed-layout records with verifier-managed fields such as `bpf_timer` |
