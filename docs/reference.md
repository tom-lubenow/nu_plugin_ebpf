...
| `ebpf spec` | Inspect parsed target metadata, context family, argument/return access mode, capabilities, section naming, live-attach/default-safety support, and compatibility requirements; pass `--list` for all modeled program families |
