...
String-to-integer parsing helpers `bpf_strtol` and `bpf_strtoul` are modeled for escape-hatch use with stack/map input buffers and 8-byte stack/map result slots.
