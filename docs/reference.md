...
| `is-empty` / `is-not-empty` | Stack-backed lists, tracked strings, literal binary, literal null, literal list constants and fixed-layout list builders, and metadata-backed fixed records |
