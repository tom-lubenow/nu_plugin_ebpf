...
| `ebpf spec` | Inspect parsed target metadata, section naming, live-attach/default-safety support, and compatibility requirements; pass `--list` for all modeled program families |
