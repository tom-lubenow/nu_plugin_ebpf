...
Socket lookup helpers `bpf_sk_lookup_tcp`, `bpf_sk_lookup_udp`, and `bpf_skc_lookup_tcp` require `tuple_size` in `0..=u32::MAX`, `netns` in signed 32-bit range (`i32::MIN..=i32::MAX`), and reserved flags set to `0`.
