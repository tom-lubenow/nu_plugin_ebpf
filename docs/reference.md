...
object. Compiled-feature metadata currently covers BPF-to-BPF subprogram calls
and bounded backward-branch loops. Compiled program/object metadata also
exposes an aggregate `compatibility_minimum_kernel` across those
