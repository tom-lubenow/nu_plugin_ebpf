const VERIFIER_DIFF_FIXTURES_3066_3069 = [
    ...
    {
        name: "core-first-empty-stack-backed-list"
        category: "language-core"
        tags: [aggregate list first empty accept]
        target: "kprobe:ksys_read"
        program: [
            '{|ctx|'
            '  [] | first'
    ...
    {
        name: "core-last-empty-stack-backed-list"
        category: "language-core"
        tags: [aggregate list last empty accept]
        target: "kprobe:ksys_read"
        program: [
            '{|ctx|'
            '  [] | last'
