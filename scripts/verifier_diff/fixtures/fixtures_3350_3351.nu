export const VERIFIER_DIFF_FIXTURES_3350_3351 = [
    ...
    {
        name: "global-define-type-array-string-str-index-of-grapheme-zero-fill-sum"
        category: "globals"
        tags: [globals arrays string str index-of grapheme-clusters math sum global-define accept]
        target: "raw_tracepoint:sys_enter"
        program: [
            '{|ctx|'
            '  global-define --type "array{string:8:2}" names'
            '  (((global-get names) | str index-of --grapheme-clusters "a" | math sum) == -2)'
            '}'
        ]
        local: "accept"
        kernel: "accept"
