const VERIFIER_DIFF_FIXTURES_2673_2681 = [
    {
        ...
        local: "reject"
        kernel: "skip"
        error_contains: "Environment variable access ($env.PATH) is not supported in eBPF"
    }
    {
        ...
        local: "reject"
        kernel: "skip"
        error_contains: "Setting environment variable ($env.NU_EBPF_TEST) is not supported in eBPF"
    }
    {
