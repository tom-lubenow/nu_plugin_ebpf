const PROGRAM_SURFACE_SOCKET_REDIRECT_KERNEL_FEATURE_EXPECTATIONS = [
    ...
    }
    {
        ...
        program: [
            '{|ctx|'
            '  redirect-socket peers 0 --kind sockmap; redirect-socket hash_peers 0 --kind sockhash'
            '  "pass"'
            '}'
        ]
        feature_keys: [
    ...
    }
    {
        ...
        program: [
            '{|ctx|'
            '  helper-call "bpf_msg_redirect_hash" $ctx hash_peers "peer-a" 0; redirect-socket peers 0 --kind sockmap'
            '  "pass"'
            '}'
        ]
        feature_keys: ["helper:bpf_msg_redirect_map"]
    }
    {
