...
echo "[1/25] stream attach (kprobe:ksys_read)"
run_nu 'ebpf attach -s "kprobe:ksys_read" {|ctx| $ctx.pid | emit } | first 1'

echo "[2/25] attach -> counters -> detach"
...
echo "[3/25] tracepoint + read-str with null guard"
...
echo "[4/25] fentry trampoline arg"
...
echo "[5/25] fentry pointer-backed trampoline field"
...
echo "[6/25] fentry intermediate trampoline pointer hop"
...
echo "[7/25] fentry post-binding pointer field projection"
...
echo "[8/25] fentry deeper post-binding pointer field projection"
...
echo "[9/25] fentry multi-level trampoline pointer hop"
...
echo "[10/25] fentry direct pointer index"
...
echo "[11/25] fentry bound root trampoline arg"
...
echo "[12/25] fentry bound pointer index"
...
echo "[13/25] fentry bound numeric get"
...
echo "[14/25] fentry trampoline array element"
...
echo "[15/25] fentry trampoline array leaf"
...
echo "[16/25] fentry trampoline struct leaf emit decodes record"
...
echo "[17/25] fentry trampoline struct leaf count decodes record key"
...
echo "[18/25] fexit trampoline retval"
...
echo "[19/25] bounded loop-driven numeric get"
...
echo "[20/25] bounded arithmetic-derived numeric get"
...
echo "[21/25] typed runtime-field numeric get"
...
echo "[22/25] runtime get on stack-backed array leaf"
...
echo "[23/25] branch-refined bound numeric get"
...
echo "[24/25] branch-refined direct numeric get"
...
echo "[25/25] verify no leaked probes"
