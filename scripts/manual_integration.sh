...
echo "[1/26] stream attach (kprobe:ksys_read)"
run_nu 'ebpf attach -s "kprobe:ksys_read" {|ctx| $ctx.pid | emit } | first 1'

echo "[2/26] attach -> counters -> detach"
...
echo "[3/26] tracepoint + read-str with null guard"
...
echo "[4/26] fentry trampoline arg"
...
echo "[5/26] fentry pointer-backed trampoline field"
...
echo "[6/26] fentry intermediate trampoline pointer hop"
...
echo "[7/26] fentry post-binding pointer field projection"
...
echo "[8/26] fentry deeper post-binding pointer field projection"
...
echo "[9/26] fentry multi-level trampoline pointer hop"
...
echo "[10/26] fentry direct pointer index"
...
echo "[11/26] fentry bound root trampoline arg"
...
echo "[12/26] fentry bound pointer index"
...
echo "[13/26] fentry bound numeric get"
...
echo "[14/26] fentry trampoline array element"
...
echo "[15/26] fentry trampoline array leaf"
...
echo "[16/26] fentry trampoline struct leaf emit decodes record"
...
echo "[17/26] fentry trampoline struct leaf count decodes record key"
...
echo "[18/26] fexit trampoline retval"
...
echo "[19/26] bounded loop-driven numeric get"
...
echo "[20/26] bounded arithmetic-derived numeric get"
...
echo "[21/26] typed runtime-field numeric get"
...
echo "[22/26] runtime get on stack-backed array leaf"
...
echo "[23/26] runtime get on stack-backed aggregate bitfield"
...
echo "[24/26] branch-refined bound numeric get"
...
echo "[25/26] branch-refined direct numeric get"
...
echo "[26/26] verify no leaked probes"
