...
echo "[1/19] stream attach (kprobe:ksys_read)"
run_nu 'ebpf attach -s "kprobe:ksys_read" {|ctx| $ctx.pid | emit } | first 1'

echo "[2/19] attach -> counters -> detach"
...
echo "[3/19] tracepoint + read-str with null guard"
...
echo "[4/19] fentry trampoline arg"
...
echo "[5/19] fentry pointer-backed trampoline field"
...
echo "[6/19] fentry intermediate trampoline pointer hop"
...
echo "[7/19] fentry post-binding pointer field projection"
...
echo "[8/19] fentry deeper post-binding pointer field projection"
...
echo "[9/19] fentry multi-level trampoline pointer hop"
...
echo "[10/19] fentry direct pointer index"
...
echo "[11/19] fentry bound root trampoline arg"
...
echo "[12/19] fentry bound pointer index"
...
echo "[13/19] fentry bound numeric get"
...
echo "[14/19] fentry trampoline array element"
...
echo "[15/19] fentry trampoline array leaf"
...
echo "[16/19] fentry trampoline struct leaf emit decodes record"
...
echo "[17/19] fentry trampoline struct leaf count decodes record key"
...
echo "[18/19] fexit trampoline retval"
...
echo "[19/19] verify no leaked probes"
