...
echo "[1/24] stream attach (kprobe:ksys_read)"
run_nu 'ebpf attach -s "kprobe:ksys_read" {|ctx| $ctx.pid | emit } | first 1'

echo "[2/24] attach -> counters -> detach"
...
echo "[3/24] tracepoint + read-str with null guard"
...
echo "[4/24] fentry trampoline arg"
...
echo "[5/24] fentry pointer-backed trampoline field"
...
echo "[6/24] fentry intermediate trampoline pointer hop"
...
echo "[7/24] fentry post-binding pointer field projection"
...
echo "[8/24] fentry deeper post-binding pointer field projection"
...
echo "[9/24] fentry multi-level trampoline pointer hop"
...
echo "[10/24] fentry direct pointer index"
...
echo "[11/24] fentry bound root trampoline arg"
...
echo "[12/24] fentry bound pointer index"
...
echo "[13/24] fentry bound numeric get"
...
echo "[14/24] fentry trampoline array element"
...
echo "[15/24] fentry trampoline array leaf"
...
echo "[16/24] fentry trampoline struct leaf emit decodes record"
...
echo "[17/24] fentry trampoline struct leaf count decodes record key"
...
echo "[18/24] fexit trampoline retval"
...
echo "[19/24] bounded loop-driven numeric get"
...
echo "[20/24] bounded arithmetic-derived numeric get"
...
echo "[21/24] typed runtime-field numeric get"
...
echo "[22/24] branch-refined bound numeric get"
...
echo "[23/24] branch-refined direct numeric get"
...
echo "[24/24] verify no leaked probes"
